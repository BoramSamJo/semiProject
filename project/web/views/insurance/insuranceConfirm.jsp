...
<body>
    ...
    <header id = 'nav'>
        ...
        <section>
            ...
            <div id="headline">
                <span><a href='<%=request.getContextPath() %>/views/insurance/insuranceMain.jsp'>보험소개</a></span>
	            <span><a href='<%=request.getContextPath() %>/views/insurance/insuranceContent.jsp'>보장내용</a></span>
                ...
                <div id="infoTable">
                    <table id="info" align="center" width="680px" height="500px" style="border-bottom: none; border-left: none; border-right: none;">
                        ...
                        <tr>
                            ...
                            <td><%=((Member)request.getSession().getAttribute("loginUser")).getmId() %></td>
                            <%}else{%>
                            <td>
                            	로그인 하시죠
                           	</td>
                        ...
                        <tr style="border-bottom: none; border-left: none; border-right: none;">
                            <td style="border-bottom: none; border-left: none; border-right: none;" id="buttontest123">
                            <button id="goHome" onclick="goHome()"><a href='<%=request.getContextPath() %>/views/insurance/insuranceMain.jsp'>처음으로</a></button>
                            </td>
                            <td id="button123" style="border-bottom: none; border-left: none; border-right: none;"><button id="pay" onclick="pay();">결제하기</button></td>
                        </tr>
                    </table>
                </div>
    ...
    <script>
    function goHome(){ 
    	location.href = <%=request.getContextPath()%>/views/insurance/insuranceMain.jsp;
    }
    </script>
