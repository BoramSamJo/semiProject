...
<title>Insert title here</title>
	...
	.ins2modal_pop table td {
		padding: 10px;
	}
	/* 모달창 버튼 설정 */
	.ins2modal_pop button {
		background: -webkit-linear-gradient(top, #e0ccbb, #b3a193);
		color: #242424;
		font-size: 14px;
		font-weight: 500;
	...
	<!--섹션 시작-->
		<section>
			...
			<div id="wrap">
				<table id="detail1" align="center" width="500px" height="400px"
					...
					<tr>
						<th style="background-color: #d2c4b9;">보험상품</th>
						<th style="background-color: #d2c4b9;">보장내용</th>
					</tr>
					<tr>
						<td>반려견보험(품종견)</td>
						<td>질병상해 의료보장, 수술비용 확대보장, 피부병 보장, 슬관절 수술비 보장, 배상책임, 사망위로금 지급</td>
					</tr>
					<tr>
						<td>반려견보험(믹스견)</td>
						<td>질병상해 의료보장, 수술비용 확대보장, 피부병 보장, 슬관절 수술비 보장, 배상책임, 사망위로금 지급</td>
					...
					<tr>
						<td>반려묘보험(품종묘)</td>
						<td>질병상해 의료보장, 비뇨기질환 확장보장, 사망위로금 지급</td>
					</tr>
					<tr>
						<td>반려묘보험(믹스묘)</td>
						<td>질병상해 의료보장, 비뇨기질환 확장보장, 사망위로금 지급</td>
			...
			<form action="<%=request.getContextPath()%>/calculate.ins" method="post" onsubmit="return validate();">
				<div id="modal_confirm" class="ins2modal">

					<!-- 반려묘 모달창 띄우기 -->
					<div class="ins2modal_pop" align="center">
						<span class="ins2close">&times;</span>
		...
		<script>
            ...
            function showTerms() {
                ...
                var span = document.getElementsByClassName("ins2close")[0];
