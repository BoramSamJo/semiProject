...
<html lang="ko">
    <head>
        ...
        <style>
            ...
            ,#memberFixArea tr:nth-of-type(8)
            ,#memberFixArea tr:nth-of-type(10)
                    ...
                    <tr><th scope="row">번호</th><th scope="row">보호자 성함</th><th scope="row">반려동물 이름</th><th scope="row">예약일</th><th scope="row">예약시간</th></tr>
                   	...
                   	<%} else{%>
                    	<%for(int i=0; i<rList.size(); i++){ %>
	                    	...
	                    	<td><%=rList.get(i).getReservationDate().substring(0,10)%></td><td><%=rList.get(i).getReservationTime()%></td></tr>
                		<%} %>
                	<%} %>
                </table><br>
                ...
                <table id="memberFixTable">
                    <form id="pwdInfo">
                        ...
                        <tr>
                            ...
                            <td colspan="3"></td>
                            <td><button type="button" id="pwdChangeBtn">수정하기</button></td>
                        </tr>
                        <tr class="secretPwd">
                            <td class="fixTdTitle">변경할 비밀번호</td>
                            <td colspan="3"><input type="password" name="changePwd1" class="changePwd"></td>
                        </tr>
                        <tr class="secretPwd">
                            <td class="fixTdTitle">비밀번호 확인</td>
                            <td colspan="3"><input type="password" name="changePwd2" class="changePwd"><br><br>
                            	<p id="checkShow"></p>
                            </td>
                        ...
                        <tr class="secretPwd">
                            <td></td>
                            <td colspan="3"><button type="reset" class="cancel">취소</button>&nbsp;<button type="button" onclick="checkPwd();">변경</button></td>
                        </tr>
                    </form>
                    ...
                    <form>
                        <tr>
                            ...
                            <td><button type="button" id="emailChangeBtn">수정하기</button></td>
                        </tr>
                    ...
                    <form>
                        <tr>
                            ...
                            <td><button type="button" id="phoneChangeBtn">수정하기</button></td>
                        </tr>
                    ...
                    <form>
                        <tr>
                            ...
                            <td><button type="button" id="mapChangeBtn">수정하기</button></td>
                        </tr>
                        <tr class="secretMap">
                            <td class="fixTdTitle"></td>
                            <td colspan="3" style="line-height: 60px;">
                                <input id="zonecode" type="text" style="width:100px;" readonly/>
                                <input id="findAddressBtn" type="button" onClick="openDaumZipAddress();" value = "주소 찾기" /><br>
                                <input type="text" id="address" style="width:400px; margin-bottom: 10px;" readonly/><br>
                                <input type="text" id="address_etc" style="width:400px;" placeholder="상세주소"><br>
                                <button type="reset" class="cancel">취소</button>&nbsp;<button type="button" onclick="checkAddress();">변경</button>
                            </td>
                        </tr>
                    </form>
                    <form id="petInfo">
                    ...
                    <form>
                    	<tr class="secretPet">
                   		...
                   		<tr id="changePetInfo2">
                   			...
                   			<td><button type="button" onclick="deleteAnimal();">사망</button>
                   		</tr>
                    </form>
                    <tr>
                    	<td></td>
                    	...
                    	<td></td>
                    	<td></td>
                    	<td><button type="button" id="dropUser" onclick="deleteUser();">회원탈퇴</button></td>
                    </tr>
                </table>
            </div>
            <br>
