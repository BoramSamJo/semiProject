<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="myPage.model.vo.*, member.model.vo.Member, java.util.ArrayList"%>
<%
...
#memberFixArea tr:nth-of-type(1), #memberFixArea tr:nth-of-type(2),
	#memberFixArea tr:nth-of-type(3), #memberFixArea tr:nth-of-type(6),
	#memberFixArea tr:nth-of-type(7), #memberFixArea tr:nth-of-type(9),
	#memberFixArea tr:nth-of-type(11), #memberFixArea tr:nth-of-type(13) {
...
<body>
	...
	<section id="myPageSection">
		...
		<div id='Backarea'>
			<h1 id="myTilte1">MyPage</h1>
			<h3 id="myTilte2">마이페이지</h3>
		</div>
		...
		<div id="reservationCheckArea">
			...
			<table class="TableCSS1">
				<tr>
					<th scope="row">번호</th>
					<th scope="row">보호자 성함</th>
					<th scope="row">반려동물 이름</th>
					<th scope="row">예약일</th>
				...
				<tr class="tablehover">
					...
					<td><%=rList.get(i).getReservationDate().substring(0,10)%></td>
					<td><%=rList.get(i).getReservationTime()%>시</td>
				</tr>
				<%} %>
				<%} %>
			</table>
			...
			<table id="memberFixTable" style="vertical-align: center">
				<form id="pwdInfo">
					...
					<tr class="secretPwd" style="height: 0px;">
						...
						<td colspan="3"><input type="password" name="changePwd1"
							class="changePwd"></td>
						<td></td>
					</tr>
					<tr class="secretPwd" style="padding: 0px;">
						<td class="fixTdTitle" style="text-align: right">비밀번호 확인</td>
						<td colspan="3"><input type="password" name="changePwd2"
							class="changePwd">&nbsp;
							<p id="checkShow"></p></td>
						<td><button type="reset" class="cancel">취소</button>&nbsp;
							<button type="button" onclick="checkPwd();">변경</button></td>
					</tr>
				</form>
				...
				<form>
					...
					<tr class="secretPhone">
						...
						<td colspan="3"><input type="text" name="phoneChange">
							&nbsp;
							<button type="reset" class="cancel">취소</button>&nbsp;
							<button type="button" onclick="checkPhone();">변경</button>
						</td>
						<td></td>
					</tr>
				</form>
				...
				<form>
					...
					<tr class="secretMap">
						...
						<td colspan="3" style="line-height: 60px;">
							...
							<input id="findAddressBtn" type="button" onClick="openDaumZipAddress();" value="주소 찾기" /><br> <input type="text" id="address" style="width: 160px; margin-bottom: 10px;" readonly />&nbsp; 
							<input type="text" id="address_etc" style="width: 160px;" placeholder="상세주소"><br>
						</td>
						<td>
							<button type="reset" class="cancel">취소</button>&nbsp;
							<button type="button" onclick="checkAddress();">변경</button>
						</td>
					</tr>
				</form>
				<form id="petInfo">
				...
				<form>
					...
					<tr class="hiddenPetInfo">
						...
						<td>
							<button type="button" id="changePetInfo" onclick="petChangeBtn();" style="width: 70px;">수정</button>
						</td>
					</tr>
					<%} else{ %>
					...
					<tr id="changePetInfo2">
						<td></td>
						<td colspan="3" style="text-align: right;"><button
								type="reset" class="cancel">취소</button>&nbsp;&nbsp;
							<button type="button" onclick="petChangeBtn2();">수정</button>&nbsp;&nbsp;
							<button type="button" onclick="deleteAnimal();">사망</button></td>
						<td>
					</tr>
				</form>
				<tr>
				...
				<tr>
					...
					<td colspan="3" style="text-align: center;"><button
							...
							style="padding: 10px 20px; margin-left: -50px;">홈으로</button></td>
					<td style="text-align: center;"><button type="button"
							id="dropUser" onclick="deleteUser();"
							style="background: #242424; color: #b3a193">회원탈퇴</button></td>
