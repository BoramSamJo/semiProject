...
<%-- <%=nb %> --%>
 ...
 <!--section시작-->
        ...
        <form>
        <div id = 'headline'><span onclick="location.href='CS_NotiMain.html';">공지사항</span><span  onclick="location.href='<%=request.getContextPath()%>/manageFbList.bo';">FAQ</span><span  onclick="location.href='CS_QnA.html';">QnA</span></div>
        </form>
         <!--제목 테이블-->
         <div id="wrapContent">
            ...
            <table class="TableCSS1">
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><%=nb.getCreateDate() %></td>
                </tr>
            </table>
       ...
       <button onclick="updatetest123();" class="deletebtn">수정하기</button>
            ...
            <a href="<%=request.getContextPath()%>/manageNbList.bo;"><input type="submit" value="목록"></a>
