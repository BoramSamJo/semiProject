      ...
      eventClick: function(info){
    	...
    	<%for(int i=0; i<clist.size(); i++){%>
    		if(rId==<%=clist.get(i).getReservationNo()%>){
    			...
    			$("#hiddenRDate").text("<%=clist.get(i).getReservationDate()%>");
...
<body>
		<div id='source-calendar'></div>
	      ...
	      <div class="infoModal-content">
	                <p style="text-align: center;"><span style="font-size: 14pt;"><b><span style="font-size: 24pt;">예약상세정보</span></b></span></p>
	                <table align="center">
	                	<tr>
	                		<td>예약자 : </td>
	                		<td><p id="hiddenMName"></p></td>
	                		<td>반려동물 이름 : </td>
	                		<td><p id="hiddenAName"></p><td>
	                	</tr>
	                	<tr>
	                		<td>장례식 : </td>
	                		...
	                		<td>반려동물 품종 : </td>
	                		<td><p id="hiddenAKind"></p></td>
	                	</tr>
	                	<tr>
	                		<td>예약일자 : </td>
	                		<td><p id="hiddenRDate"></p></td>
	                		<td>예약시간 : </td>
	                		<td><p id="hiddenRTime"></p></td>
	                		<td>반려동물 무게 : </td>
	                		<td><p id="hiddenAWeight"></p></td>
	                	</tr>
	      ...
	      <div class="infoChange-content">
	                ...
	                <form>
	                	<table align="center">
			                ...
			                <tr>
			                	<td><input type="hidden" id="hiddenRNo"></td>
			                </tr>
	                	</table>
			            <div style="cursor:pointer;background-color:#DDDDDD;text-align: center;padding-bottom: 10px;padding-top: 10px;">
