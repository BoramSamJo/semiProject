	...
	<%=list %> --%>
	 ...
	 <!-- <헤더(상단 메뉴바) 시작> -->
         ...
         <header id = 'nav'>
                    ...
                    <div class="logInSection">      
                        <form action="">
                            <table id="loginT">
                                <tr>
                                    <td >
                                        <img src="LOGO/LOGO3.png" width="300" height="100" alt="">
                                    </td>
                                </tr>
                                <tr>
                                    <td><input type="text" name="userIdLogIn" id="userIdLogIn" placeholder="아이디" required></td>
                                    <!-- <td rowspan="7"> 
                                ...
                                <tr>
                                    <td>
                                        <input src="checkboxImage/비활성화상태체크박스.png" type="checkbox" name="maintenanceLogIn" id="maintenanceLogIn" value="Yes">
                                        <label for="maintenanceLogIn" id="maintenanceLogInLabel">&nbsp;로그인 상태 유지 or 아이디 저장 중 뭐할까</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input type="button" value="로그인" id="logBtn" disabled>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <div id="smallInform" align='center'>
                                            <a href="#" id="#">아이디 찾기 |</a>
                                            <a href="#" id="#"><b>비밀번호 찾기</b></a><span style="font-size: 10px; font-weight: lighter;"> |</span>
                                            <a href="semi_Join.html">회원가입</a>
                                        </div>
                                    </td>
                                </tr>
                                <!-- <tr>
            ...
            <!--상단바-->
            <ul id = 'navMenu'>
                <img id="navLogo" src="LOGO/LOGO1.png" width="130" alt="로고이미지" id = 'bigwindow_logo'>
                ...
                <li><a href="#" id = 'fifth' class="colorcss">For Member</a>
           ...
           <!-- 반응형 메뉴 -->
           <div id = 'reactMenu'>
            <img id="serveLogo" src="LOGO/LOGO1.png" width="120" alt="로고이미지" id = 'bigwindow_logo'>
               <div id="serveMenuBtn">
      ...
      <form id="searchformtest" name="searchform" method="get" action="<%=request.getContextPath()%>/list.bo">
        <div id = 'headline'><span onclick="location.href='CS_NotiMain.html';">공지사항</span><span onclick="goFAQ()">FAQ</span><span  onclick="location.href='CS_QnA.html';">QnA</span></div>
            ...
            <table class="TableCSS1" id="testtest1">
                ...
                <%}else{%>
                	...
                	<tr><!-- 번호/제목/작성자/작성일/조회 -->
                		...
                		<td><%=((noticeBoard)list.get(i)).getModifyDate() %></td><!-- 작성일-->
                	</tr>
                	<%} %>
                <%} %>
            </table><br>
