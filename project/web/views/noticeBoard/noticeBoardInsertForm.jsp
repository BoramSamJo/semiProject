...
<%@include file="../common/managebar.jsp"%>
  ...
  <!--section시작-->
      <section id="notiSection">
             <!-- 고객센터 공통 상단 -->
            <div id='Backarea'> 
                <h1 id="notiTitle1">CS SERCIVE MANAGE</h1><h3 id="notiTitle2">고객센터 관리</h3>
            </div>
           <div id="smallTitles">
                <img src="<%=request.getContextPath() %>/img/CS_icon3.png" id = 'img1'>
                <h3 id="smallTitle">글 작성</h3>
           </div>
        
            <div id="wrapTable">
            <table>
                <form name="form" id='form' action="<%=request.getContextPath() %>/insert.bo" method="post">
                    ...
                    <div id="btns">
                        <input type = 'submit' value = '등록' onclick="upload" id = 'upload'>
		                 <input type="reset" value="취소" onclick="location.href='<%=request.getContextPath()%>/manageNbList.bo';">
                    </div>
                </form>
            </table>
        </section>
