...
/**
 * Servlet implementation class SearchSketchBoardServlet
 */
@WebServlet("/search.sb")
public class SearchSketchBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchSketchBoardServlet() {
        super();
...
//		
		...
		ArrayList<SketchBoard> list = new SketchBoardService().selectList(currentPage, limit, searchText);
