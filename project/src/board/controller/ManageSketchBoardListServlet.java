...
/**
 * Servlet implementation class ManageSketchBoardListServlet
 */
@WebServlet("/manageList.ms")
public class ManageSketchBoardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManageSketchBoardListServlet() {
        super();
