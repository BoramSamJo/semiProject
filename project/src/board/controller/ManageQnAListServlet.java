...
/**
 * Servlet implementation class ManageQnAListServlet
 */
@WebServlet("/manageQList.bo")
public class ManageQnAListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManageQnAListServlet() {
        super();
