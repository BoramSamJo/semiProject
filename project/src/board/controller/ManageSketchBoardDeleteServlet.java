...
/**
 * Servlet implementation class ManageSketchBoardDeleteServlet
 */
@WebServlet("/deleteList.ms")
public class ManageSketchBoardDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManageSketchBoardDeleteServlet() {
        super();
...
//		SketchBoard sb = new SketchBoard(sbNo);
		
//		System.out.println("서블릿에서 sbNo : " + sbNo);
		
		SketchBoardService sbs = new SketchBoardService();

		int result = sbs.manageDeleteList(sbNo);
//		System.out.println("서블릿에서 : " + result);
