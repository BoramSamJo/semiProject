...
/**
 * Servlet implementation class noticeBoardListManagerServlet
 */
@WebServlet("/manageNbList.bo")
public class noticeBoardListManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public noticeBoardListManagerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		noticeBoardService nService = new noticeBoardService();
				...
				nPagenation pn = new nPagenation(listCount,currentPage,limit, maxPage, startPage,endPage,pageBlock,pageCount);
				
				
				//화면에 뿌려 줄 게시판 리스트 조회
				ArrayList list = nService.selectList(currentPage,limit);
				
				/* System.out.println("관리자 페이지 공지사항 db갔다오는지 " + list); */
