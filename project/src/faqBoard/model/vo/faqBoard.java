...
public class faqBoard implements Serializable{
	...
	//수정을 위한 생성자
	public faqBoard(int fno, int cno) {
		this.fno = fno;
		this.cno = cno;
	}
	//수정을 위한 생성자
	/*
	 * public faqBoard(int fno2, int cno2, String title, String content) {
	 * 
	 * }
	 * 
	 */

	public faqBoard(int fno, int cno, String fTitle, String fContent) {
		this.fno = fno;
		this.cno = cno;
		this.fTitle = fTitle;
		this.fContent = fContent;
